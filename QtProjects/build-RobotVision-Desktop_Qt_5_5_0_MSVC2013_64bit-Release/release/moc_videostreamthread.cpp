...
#include "../../RobotVision/videostreamthread.h"
...
QT_MOC_LITERAL(5, 44, 9), // "frameSide"
QT_MOC_LITERAL(6, 54, 6) // "origin"
...
void VideoStreamThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VideoStreamThread::*_t)(cv::Mat , int , int );
...
// SIGNAL 0
void VideoStreamThread::frameReady(cv::Mat _t1, int _t2, int _t3)
{
