...
#include "../../RobotVision/disparitycalcthread.h"
...
QT_MOC_LITERAL(4, 40, 5), // "frame"
QT_MOC_LITERAL(5, 46, 9), // "frameSide"
QT_MOC_LITERAL(6, 56, 6) // "origin"

    },
    "DisparityCalcThread\0frameReady\0\0cv::Mat\0"
...
void DisparityCalcThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DisparityCalcThread::*_t)(cv::Mat , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DisparityCalcThread::frameReady)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DisparityCalcThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DisparityCalcThread.data,
...
// SIGNAL 0
void DisparityCalcThread::frameReady(cv::Mat _t1, int _t2, int _t3)
{
